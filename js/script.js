window.addEventListener("load", () => {
  // Mostrar solo en index.html y si no se ha mostrado ya en esta sesión
  if (window.location.pathname.endsWith("index.html") && !sessionStorage.getItem("welcomeShown")) {
    setTimeout(() => {
